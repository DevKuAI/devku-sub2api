...
func AccountFromServiceShallow(a *service.Account) *Account {
	...
	if a.BoundUser != nil {
		out.BoundUser = &AccountBoundUser{
			ID:       a.BoundUser.ID,
			Username: a.BoundUser.Username,
			Email:    a.BoundUser.Email,
		}
	}
...
func AccountListItemFromAccount(a *Account) *AccountListItem {
	...
	return &AccountListItem{
		...
		BoundUserID: a.BoundUserID, BoundUser: a.BoundUser,
...
func UsageLogFromServiceAdmin(l *service.UsageLog) *AdminUsageLog {
	...
	return &AdminUsageLog{
		UsageLog:                usageLog,
		RequestBodyAvailable:    l.RequestBodyAvailable,
