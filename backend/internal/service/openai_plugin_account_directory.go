...
// later flows through automatically with no host change. These categories are
// stripped:
//
...
//
//   - BoundUserID / BoundUser: private host user bindings, unrelated to plugin
//     outbound identity.
//
...
func accountReadableSnapshotJSON(account *Account) []byte {
	...
	// User bindings are private to the host and unrelated to outbound identity.
	clone.BoundUserID = nil
	clone.BoundUser = nil
