...
func registerRoutes(
	...
	routes.RegisterBIRoutes(r, h.BI, jwtAuth, cfg)
	...
	routes.RegisterDesktopUpdateRoutes(r, h)
	registerDesktopRoutesIfEnabled(r, h, auditLog, cfg)
...
func registerDesktopRoutesIfEnabled(r *gin.Engine, h *handler.Handlers, auditLog middleware2.AuditLogMiddleware, cfg *config.Config) {
