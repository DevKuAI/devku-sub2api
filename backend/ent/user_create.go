...
func (_c *UserCreate) AddDesktopOrganizationIDs(ids ...int64) *UserCreate {
...
func (_c *UserCreate) AddDesktopOrganizations(v ...*DesktopOrganization) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) AddBoundAccountIDs(ids ...int64) *UserCreate {
	_c.mutation.AddBoundAccountIDs(ids...)
	return _c
}

// AddBoundAccounts adds the "bound_accounts" edges to the Account entity.
func (_c *UserCreate) AddBoundAccounts(v ...*Account) *UserCreate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
