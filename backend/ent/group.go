...
// DesktopOrganizationsOrErr returns the DesktopOrganizations value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) DesktopOrganizationsOrErr() ([]*DesktopOrganization, error) {
	if e.loadedTypes[6] {
		return e.DesktopOrganizations, nil
	}
...
// QueryDesktopOrganizations queries the "desktop_organizations" edge of the Group entity.
func (_m *Group) QueryDesktopOrganizations() *DesktopOrganizationQuery {
	return NewGroupClient(_m.config).QueryDesktopOrganizations(_m)
}
