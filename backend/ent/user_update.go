...
func (_u *UserUpdate) AddDesktopOrganizationIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) AddDesktopOrganizations(v ...*DesktopOrganization) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) ClearDesktopOrganizations() *UserUpdate {
...
func (_u *UserUpdate) RemoveDesktopOrganizationIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) RemoveDesktopOrganizations(v ...*DesktopOrganization) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.DesktopOrganizationsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.DesktopOrganizationsTable,
			Columns: []string{user.DesktopOrganizationsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddDesktopOrganizationIDs adds the "desktop_organizations" edge to the DesktopOrganization entity by IDs.
func (_u *UserUpdateOne) AddDesktopOrganizationIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddDesktopOrganizationIDs(ids...)
	return _u
}

// AddDesktopOrganizations adds the "desktop_organizations" edges to the DesktopOrganization entity.
func (_u *UserUpdateOne) AddDesktopOrganizations(v ...*DesktopOrganization) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearDesktopOrganizations clears all "desktop_organizations" edges to the DesktopOrganization entity.
func (_u *UserUpdateOne) ClearDesktopOrganizations() *UserUpdateOne {
	_u.mutation.ClearDesktopOrganizations()
	return _u
}

// RemoveDesktopOrganizationIDs removes the "desktop_organizations" edge to DesktopOrganization entities by IDs.
func (_u *UserUpdateOne) RemoveDesktopOrganizationIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveDesktopOrganizationIDs(ids...)
	return _u
}

// RemoveDesktopOrganizations removes "desktop_organizations" edges to DesktopOrganization entities.
func (_u *UserUpdateOne) RemoveDesktopOrganizations(v ...*DesktopOrganization) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
