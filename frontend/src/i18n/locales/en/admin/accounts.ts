export default {
    accounts: {
      ...
      binding: {
        title: 'Bind User',
        description: 'Choose the user who can view this subscription account',
        action: 'Manage bound user',
        actionShort: 'Bind',
        account: 'Subscription account',
        currentUser: 'Currently bound user',
        selectUser: 'Select user',
        searchUser: 'Search name or email...',
        noUsers: 'No users found',
        unbound: 'Not bound',
        hint: 'A user can view multiple subscription accounts. Each account can be bound to one user.',
        saved: 'User binding updated',
        removed: 'Bound user removed',
        conflict: 'The account binding changed in another session. The page has been refreshed; try again.',
        saveFailed: 'Failed to update user binding',
        loadFailed: 'Failed to load account',
        retry: 'Retry',
        removeUser: 'Remove user',
        removeTitle: 'Remove bound user',
        removeConfirm: 'Remove “{user}” from “{account}”? This user will no longer be able to view this subscription account.'
      },
