export default {
  ...
  keys: {
    ...
    creationQuota: 'API Keys {used} / {limit}',
    creationQuotaUnlimited: '{used} API Keys, unlimited',
    creationLimitReached: 'API key creation limit reached',
    ...
    failedToLoadCreationQuota: 'Failed to load API key creation quota',
