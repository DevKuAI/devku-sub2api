export default {
    accounts: {
      ...
      binding: {
        ...
        noUsers: '未找到可绑定用户',
        unbound: '未绑定',
        hint: '一个用户可以查看多个订阅账号，一个订阅账号只能绑定一个用户。',
        saved: '用户绑定已更新',
        removed: '已移除绑定用户',
        conflict: '账号绑定已被其他管理员修改，页面已刷新，请重试',
        saveFailed: '更新用户绑定失败',
        loadFailed: '加载账号信息失败',
        retry: '重试',
        removeUser: '移除用户',
        removeTitle: '移除绑定用户',
        removeConfirm: '确定要从“{account}”移除用户“{user}”吗？移除后该用户将无法再查看此订阅账号。'
      },
      editAccount: '编辑账号',
      deleteAccount: '删除账号',
      searchAccounts: '搜索账号...',
