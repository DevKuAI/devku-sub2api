...
curl -sSL https://raw.githubusercontent.com/DevKuAI/devku-sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
chmod +x docker-deploy.sh
./docker-deploy.sh
```

**What the script does:**
- Downloads the local-directory Compose variant as `docker-compose.yml` and downloads `.env.example`
...
1. Download the latest release from [GitHub Releases](https://github.com/DevKuAI/devku-sub2api/releases)
