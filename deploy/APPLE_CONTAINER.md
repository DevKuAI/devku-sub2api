...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=huanghua581/devku-sub2api:latest
...
SUB2API_IMAGE=huanghua581/devku-sub2api:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
